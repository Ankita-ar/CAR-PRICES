...
def prediction(input_data):
    ...
    return f' The estimated price of the car is : ${pred[0]:.2f}'
...
def main():
    ...
    wl = float(st.text_input('What is the wheelbase?'))
    cl = float(st.text_input('What is the length of the car?'))
    cw = float(st.text_input('What is the width of the car?'))
    ch = float(st.text_input('What is the height of the car?'))
    curbw = float(st.text_input('What is the curbweight of the car?'))
    ...
    es = float(st.text_input('What is the engine size?'))
    ...
    br = float(st.text_input('What is the bore ratio of the car?'))
    stroke = float(st.text_input('How much is the stroke or volume inside the engine?'))
    cr = float(st.text_input('What is the compression ratio of the car?'))
    hp = float(st.text_input('What is the horsepower of the car?'))
    rpm = float(st.text_input('What is the car peak rpm?'))
